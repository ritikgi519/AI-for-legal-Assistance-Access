      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 id="export-modal-title" className="text-base font-bold text-white font-['Cinzel',serif]">
        ...
        {/* Tab Selection */}
        <div role="tablist" aria-label="Export Format" className="flex items-center justify-between border-b border-slate-800 bg-slate-950/40 px-6 pt-2">
          <div className="flex gap-2">
            <button
              role="tab"
              aria-selected={activeTab === 'json'}
              onClick={() => setActiveTab('json')}
              className={`pb-3 px-3 text-xs font-semibold border-b-2 transition cursor-pointer flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none ${
                activeTab === 'json'
